...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (passwordField && passwordFeedback) {
        ...
        // Add event listeners for the scrapers password field (works for both password and new_password)
        ...
        if (confirmPasswordField) {
            ...
            // Also validate confirm password when scrapers password changes
            passwordField.addEventListener('input', function() {
                validateAndUpdateFeedback(); // Validate scrapers password
